...
import 'package:coffee_shop_admin/screens/drink_management/size_item.dart';
        ...
        children: [
          Expanded(
            child: Container(
              ...
              child: BlocBuilder<SizeListBloc, SizeListState>(
                ...
                if (state is LoadedState) {
                  return Stack(
                    children: [
                      RefreshIndicator(
                        onRefresh: () async {
                          BlocProvider.of<SizeListBloc>(context)
                              .add(FetchData());
                        },
                        child: ListView(
