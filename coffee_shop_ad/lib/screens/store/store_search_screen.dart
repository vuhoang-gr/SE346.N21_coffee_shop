...
import 'package:coffee_shop_admin/services/blocs/search_store/search_store_state.dart';
...
class StoreSearchScreen extends StatefulWidget {
  ...
  const StoreSearchScreen({super.key, this.isPurposeForShowDetail = false});
...
class _StoreSearchScreenState extends State<StoreSearchScreen> {
  ...
  void initState() {
    ...
    BlocProvider.of<SearchStoreBloc>(context).add(UpdateList(listStore: []));
    super.initState();
  }
