...
class _SizeDetailState extends State<SizeDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    void _handleOnTapEditSize() async {
      Navigator.of(context).pushNamed(EditSizeScreen.routeName, arguments: widget.product);
    }
    ...
    void _handleOnTapDeleteSize() async {
      await QuickAlert.show(
        ...
        onConfirmBtnTap: () async {
          ...
          try {
            await FirebaseFirestore.instance.collection("Size").doc(widget.product.id).delete().then((value) {
              Navigator.of(context).pop();
              Navigator.of(context).pop();
                ...
                children: [
                  ...
                  Expanded(
                      child: SingleChildScrollView(
                          child: Column(
                    children: [SizeCard(product: widget.product), SizedBox(height: 16)],
                  ))),
