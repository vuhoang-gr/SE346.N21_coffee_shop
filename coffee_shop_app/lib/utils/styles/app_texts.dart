...
class AppText {
  ...
  final regularBlack16 = TextStyle(
      fontSize: Dimension.font16, height: 1.5, color: AppColors.blackColor);
  final regularBlack14 = TextStyle(
      fontSize: Dimension.font14, height: 1.5, color: AppColors.blackColor);
  final regularBlack14Blur = TextStyle(
      fontSize: Dimension.font14, height: 1.5, color: AppColors.blackBlurColor);
  final regularGrey16 = TextStyle(
      fontSize: Dimension.font16, height: 1.5, color: AppColors.greyTextColor);
