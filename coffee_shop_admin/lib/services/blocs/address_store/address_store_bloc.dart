...
class AddressStoreBloc extends Bloc<AddressStoreEvent, AddressStoreState> {
  ...
  void _onListAddressInited(ListAddressInited event, Emitter<AddressStoreState> emit) {
    emit(LoadingState(listDeliveryAddress: []));
    emit(LoadedState(listDeliveryAddress: Data.addresses));
  }

  void _onListAddressUpdatedIndex(ListAddressUpdatedIndex event, Emitter<AddressStoreState> emit) {
  ...
  void _onListAddressInserted(ListAddressInserted event, Emitter<AddressStoreState> emit) {
    emit(LoadingState(listDeliveryAddress: state.listDeliveryAddress));
    List<Address> deliveryAddresses = state.listDeliveryAddress;
  ...
  void _onListAddressDeletedIndex(ListAddressDeletedIndex event, Emitter<AddressStoreState> emit) {
    emit(LoadingState(listDeliveryAddress: state.listDeliveryAddress));
    List<Address> deliveryAddresses = state.listDeliveryAddress;
